...
return [
    'modules' => [
        ...
        'Vnecoms_Core' => 1,
        'Vnecoms_Credit' => 1,
        'Vnecoms_DisablePageBuilder' => 1,
        'Vnecoms_SmTheme' => 1,
        'Vnecoms_Vendors' => 1,
        'Vnecoms_VendorsApi' => 1,
        'Vnecoms_VendorsAvatarProfile' => 1,
        'Vnecoms_VendorsCommission' => 1,
        'Vnecoms_VendorsCommissionPreview' => 1,
        'Vnecoms_VendorsConfig' => 1,
        'Vnecoms_VendorsNotification' => 1,
        'Vnecoms_VendorsSales' => 1,
        'Vnecoms_VendorsCreditGraphQl' => 1,
        'Vnecoms_VendorsCustomRegister' => 1,
        'Vnecoms_VendorsCredit' => 1,
        'Vnecoms_VendorsDashboard' => 1,
        'Vnecoms_VendorsDashboardGraphQl' => 1,
        'Vnecoms_VendorsGraphQl' => 1,
        'Vnecoms_VendorsLanguage' => 1,
        'Vnecoms_VendorsPage' => 1,
        'Vnecoms_VendorsConfigApproval' => 1,
        'Vnecoms_VendorsNotificationGraphQl' => 1,
        'Vnecoms_VendorsLayerNavigation' => 1,
        'Vnecoms_VendorsProduct' => 1,
        'Vnecoms_VendorsProductBundle' => 1,
        'Vnecoms_VendorsProductConfigurable' => 1,
        'Vnecoms_VendorsProductDownloadable' => 1,
        'Vnecoms_VendorsProductGraphQl' => 1,
        'Vnecoms_VendorsProductGrouped' => 1,
        'Vnecoms_VendorsProductImportExport' => 1,
        'Vnecoms_VendorsProductVideo' => 1,
        'Vnecoms_VendorsProfileNotification' => 1,
        'Vnecoms_VendorsReport' => 1,
        'Vnecoms_VendorsReportGraphQl' => 1,
        'Vnecoms_VendorsCustomWithdrawal' => 1,
        'Vnecoms_VendorsSalesGraphQl' => 1,
        'Vnecoms_VendorsTranslateInline' => 1,
        'Vnecoms_VendorsUi' => 1,
        'WeltPixel_Backend' => 1,
