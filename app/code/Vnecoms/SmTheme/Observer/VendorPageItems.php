...
class VendorPageItems implements ObserverInterface
{
    /**
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if($controller->getRequest()->getParam('vesAjax')){
            $productsBlockHtml = $this->view->getLayout()->getBlock('vendor.products.list')->setTemplate('Vnecoms_SmTheme::products.phtml')->toHtml();
