...
namespace Madkting\Connect\Ui\Component\Listing\Columns\Order;
...
{
    /**
     * Magento channel code
     */
    const MAGENTO_CHANNEL_CODE = 0;
    ...
    {
        $options = [
            ['value' => self::MAGENTO_CHANNEL_CODE, 'label' => 'Magento']
        ];
