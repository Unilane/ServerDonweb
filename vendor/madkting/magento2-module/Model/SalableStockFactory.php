...
/**
 * Factory class for @see \Madkting\Connect\Model\SalableStock
 * @package Madkting\Connect\Model
 */
class SalableStockFactory
{
    /**
    ...
    /**
     * Return stock manager according to Magento's version
     *
     * @return mixed
     */
    public function create()
    {
        ...
        if (version_compare($magentoVersion, '2.3', '<')) {
            return $this->objectManager->create('\\Magento\\CatalogInventory\\Api\\StockRegistryInterface');
        } else {
            return $this->objectManager->create('\\Magento\\InventorySalesAdminUi\\Model\\GetSalableQuantityDataBySku');
        }
    }
}
