 ...
 * @package Madkting\Connect\Controller\Adminhtml\Mapping
 */
class AttributeOptions extends Action
{
    ...
    public function execute()
    {
        ...
        $pageResult->setActiveMenu('Madkting_Connect::attribute_options');
        $pageResult->getConfig()->getTitle()->prepend(__('Match - Attribute Options'));
